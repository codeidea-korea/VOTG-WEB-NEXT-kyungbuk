...
export const FileDropzone = (props) => {
    ...
    return (
        <div {...other}>
            <DefaultWarningPopover onClose={handleCloseDefaultWarning} open={openDialogDefaultWarning} title={'다운받은 양식을 수정해서 사용해주세요.'} />
            ...
            {files.length == 0 && (
                ...
                >
                    ...
                    >
                        <Typography variant="button">연락처 파일을 선택해주세요.</Typography>
                    </Box>
                    <Button
                        onClick={open}
                        size="large"
