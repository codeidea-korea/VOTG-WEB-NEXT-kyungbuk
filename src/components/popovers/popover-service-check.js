...
const ServiceCheckPopover = (props) => {
...
ServiceCheckPopover.propTypes = {
    onClose: PropTypes.func,
    open: PropTypes.bool,
}

ServiceCheckPopover.getLayout = (page) => <GuestGuard>{page}</GuestGuard>

export default ServiceCheckPopover
