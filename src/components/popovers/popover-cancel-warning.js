...
const CancelWarningPopover = (props) => {
    const { onClose, open, event, title, description, cancelName, confirmName, ...other } = props
...
CancelWarningPopover.propTypes = {
...
export default CancelWarningPopover
