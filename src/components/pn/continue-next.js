...
const ContinueNext = ({ currentStepPercent, onPopupController }) => {
            ...
            <Box sx={{ pt: 0, pb: 1, display: 'flex', flexWrap: 'wrap', flexDirection: 'column', height: '100%', alignItems: 'center' }}>
                ...
                <Box sx={{ width: '100%', display: 'flex', flexWrap: 'wrap', flexDirection: 'row' }}>
                    <Typography sx={{ width: '100%', my: 3, color: 'text.main', fontSize: '1.3rem', fontWeight: 700, textAlign: 'center' }}>
                        축하합니다!
                        <br />
                        설문 응답 {currentStepPercent}% 를 완료하여 <br />
                        리워드를 지급받았습니다. <br /> 계속 하시겠습니까?
                    </Typography>
                </Box>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={5}>
                        <Button component="a" href="/panel/board" variant="outlined" color="secondary" size="large" fullWidth>
                            아니요
                        </Button>
                    </Grid>
                    <Grid item xs={7}>
                        <Button onClick={onPopupController} variant="contained" color="info" size="large" fullWidth>
                            네
                        </Button>
                    </Grid>
                </Grid>
