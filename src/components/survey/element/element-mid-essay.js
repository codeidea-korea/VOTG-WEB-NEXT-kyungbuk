...
const Element_MidEssay = (props) => {
    ...
    const onChangeEssayAnswer = (event, selectedIndex, innerItem) => {
        ...
        if (writeToggle) {
            ...
            // console.log('onChangeEssayAnswer - type', updateList)
    ...
    return (
        <Box sx={{ pt: 0, mb: 3 }}>
            {questionItem.answer.map((a, aIndex) => {
                return (
                    <Fragment key={`question-essay-key-${aIndex}`}>
                        <FormControlLabel
                            value={aIndex + 1}
                            control={<></>}
                            sx={{
                            ...
                            label={
                                <TextField
                                    ...
                                    onChange={(e) => onChangeEssayAnswer(e, questionIndex, a)}
...
export default Element_MidEssay
